  ...
  return (
    <div className="py-10">
      ...
      <div className="flex lg:flex-row justify-between items-center flex-col mt-20">
        <h1 className="font-black mb-2 pb-1 text-xl"> {product.title}</h1>
      ...
      <div>
        <Paragraph className="max-w-xl mt-4 text-md dark:text-[#e7e5d5]">{product.description}</Paragraph>
      </div>
      <div className="prose prose-sm md:prose-base max-w-none text-neutral-600  dark:text-[#697565]">
        {product?.content}
      </div>
